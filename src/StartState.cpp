...
void StartState::render(sf::RenderWindow& window)
{
	...
	drawCenteredText(font, window, "Use your space ship to shoot aliens!", -20.f);
	...
	drawCenteredText(font, window, "Press A for Speed Boost that makes you faster", 150.f, true);
	drawCenteredText(font, window, "Press S for Power Shot that pierces through enemies.", 200.f, true);
